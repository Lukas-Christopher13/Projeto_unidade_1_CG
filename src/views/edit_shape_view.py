...
class EditShapeView(Frame):
    def __init__(self, root, **kwargs):
        ...
        transforms_group.grid(row=1, column=0, sticky="ew", padx=8)
        ...
        actions_group.grid(row=2, column=0, sticky="ew", padx=8, pady=(8, 0))
        ...
        btn_clear_all.grid(row=2, column=0, columnspan=2, sticky="ew")
